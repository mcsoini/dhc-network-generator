...
grump_0 = importdata('asds00ag.asc',' ',6);
grump = grump_0;
...
filename = 'JAPAN_output_1501_160517'
...
out_file_name = ['JAPAN_output',timstr,'.dat'];
...
BGS = m_shaperead('JAPAN_buildings')
RDS = m_shaperead('JAPAN_roads')
