...
cntind = strfind(BRD.name,'Switzerland');
...
pcolorjw(xvec,yvec,log(heatdens_shr))
...
filename = 'SWITZERLAND_output_1955_160509'
...
BGS = m_shaperead('SWITZERLAND_buildings')
RDS = m_shaperead('SWITZERLAND_roads')
